import { criticalDataFileNames, taskStoreFileName } from "@/lib/data-files";

export function createBackupReadme({ copiedFiles, createdAt }: { copiedFiles: string[]; createdAt: string }) {
