...
export function taskApiPath(taskId: string) {
  return `${tasksApiPath}/${taskId}`;
}

export function taskCommentsApiPath(taskId: string) {
  return `${taskApiPath(taskId)}/comments`;
}

export function taskCompleteApiPath(taskId: string) {
  return `${taskApiPath(taskId)}/complete`;
}

export function taskConfirmRewardApiPath(taskId: string) {
  return `${taskApiPath(taskId)}/confirm-reward`;
}

export function taskRestoreApiPath(taskId: string) {
  return `${taskApiPath(taskId)}/restore`;
}

export function taskUncompleteApiPath(taskId: string) {
